...
export default function EditUser(){
    ...
    function getUser() {
        axios.get(`http://192.168.118.241:5000/userdetails/${id}`).then(function(response) {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put(`http://192.168.118.241:5000/userupdate/${id}`, inputs).then(function(response){
            console.log(response.data);
            navigate('/');
        });
